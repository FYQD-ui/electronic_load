...
/* Private defines -------------------------------------------------------------*/
#define LOAD_VOLT_ADC_PIN    GPIO_PINS_3
#define LOAD_VOLT_ADC_GPIO_PORT    GPIOA
#define REV_FAULT_PIN    GPIO_PINS_4
#define REV_FAULT_GPIO_PORT    GPIOA
#define OV_FAULT_PIN    GPIO_PINS_5
#define OV_FAULT_GPIO_PORT    GPIOA
#define SW_SCL_PIN    GPIO_PINS_14
#define SW_SCL_GPIO_PORT    GPIOB
#define SW_SDA_PIN    GPIO_PINS_15
