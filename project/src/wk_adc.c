...
void wk_adc1_init(void)
{
  ...
  gpio_init_struct.gpio_mode = GPIO_MODE_ANALOG;
  gpio_init_struct.gpio_pins = LOAD_VOLT_ADC_PIN;
  gpio_init(LOAD_VOLT_ADC_GPIO_PORT, &gpio_init_struct);
  ...
  adc_ordinary_channel_set(ADC1, ADC_CHANNEL_3, 2, ADC_SAMPLETIME_71_5);
